    ...
    return(
        <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
          <article id="about" className={`${this.props.article === 'about' ? 'active': ''} ${this.props.articleTimeout ? 'timeout': ''}`} style={{display:'none'}}>
            ...
            <p>
              <strong>Is it possible to reanimate ourselves even after death?</strong>
            </p>
            ...
            <p>
              ...
              us to develop models upon our own provided data. Given the current available technique in machine learning and deep learning,
              recreating ourselves digitally becomes a realistic possibility.
            </p>
            ...
            <p>
              ...
              We investigate on a few generative techniques: Markov Chain Generation and Recurrent Neural Networks.
